  ...
  Widget build(BuildContext context) {
    return LoadingScreen(
      ...
      child: ListView(
        ...
        children: [
          CustomSideTextWidget(text: Strings.cardName.tr,
         ),
          Gap(2.h),
          CustomHomeDetailsTextWidget(text: Strings.writtenOnCard.tr,
          ...
          Gap(2.h),
          CustomHomeDetailsTextWidget(text: Strings.digitNumber.tr,
            style: TextStyleHelper.of(context).b_14.copyWith(
                color: ThemeClass.of(context).secondaryBlackColor.withOpacity(0.6)
            ),),
          Gap(10.h),
          ...
          Gap(2.h),
          CustomHomeDetailsTextWidget(text: Strings.monthAndYear.tr,
            style: TextStyleHelper.of(context).b_14.copyWith(
                color: ThemeClass.of(context).secondaryBlackColor.withOpacity(0.6)
            ),),
          Gap(10.h),
          ...
          Gap(2.h),
          CustomHomeDetailsTextWidget(text: Strings.backNumberCard.tr,
            style: TextStyleHelper.of(context).b_14.copyWith(
                color: ThemeClass.of(context).secondaryBlackColor.withOpacity(0.6)
            ),),
          Gap(10.h),
